...
# ═══════════════════════════════════════════════════════════════════════════
ADMIN_ID = 7729136758
BOT_TOKEN = "8527481307:AAFxYMltLYBska4Uw9_C5oOAqdfGWlHX83U"
API_ID = 38610969
API_HASH = "30a0fad90983019a2723e1c2ee9309bf"

# ─── СЕССИИ ДЛЯ ПУЛА (8 шт.) ──────────────────────────────────────────────────
POOL_SESSIONS = [
    ("marketsess1", "+14306007667"),
    ("marketsess2", "+18455202836"),
    ("marketsess3", "+17408408947"),
    ("marketsess4", "+19795304811"),
    ("marketsess5", "+12185776428"),
    ("marketsess6", "+16727680666"),
    ("marketsess7", "+17407948366"),
    ("marketsess8", "+17167092896"),
]
POOL_CONCURRENCY_PER_SESSION = 2

# ─── ГРУППА С ВЕТКАМИ-ТЕМАМИ (Topics/форум) ──────────────────────────────────
GROUP_ID = -1004408814417        # супергруппа с включёнными «Темами»
TOPIC_THREADS = {
    "black": 2,   # Black
    "dear":  4,   # A lot of money gifts
    "cheap": 5,   # Poor gifts
    "all":   3,   # All gift
}
...
DEAR_WHITELIST = {
    ...
    "Ionic Dryer", "Skull Flower", "Sky Stilettos", "Sleigh Bell",
    "Low Rider", "Love Candle", "Flying Broom", "Crystal Ball",
    "Trapped Heart", "Record Player", "Diamond Ring", "Cupid Charm",
    "Eternal Rose", "Vintage Cigar", "Voodoo Doll", "Swiss Watch",
    "Love Potion", "Toy Bear",
}
